...
in
{
  ...
  services.dnsmasq = {
    ...
    settings = {
      ...
      dhcp-range = [ "lan3,192.168.10.100,192.168.10.254" 
"vlan120,192.168.15.100,192.168.15.254"
      ];
      interface = [ "vlan120" "lan3" ];
      dhcp-host = ["vlan120,192.168.15.1" "lan3,192.168.10.1"];
